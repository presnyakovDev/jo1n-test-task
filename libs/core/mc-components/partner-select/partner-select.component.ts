...
export class McPartnerSelectDialogComponent implements OnInit {
  displayedColumns = ['partnerCaption', 'infoStatus', 'description'];
  ...
  constructor(
    ...
    private itemsApiService: PartnersApiService,
    public dialogRef: MatDialogRef<McPartnerSelectDialogComponent>,
  ...
  drop() {
    ...
    confirmDialogRef.afterClosed().subscribe(result => {
      ...
      const item = new Partner({ id: null });
  ...
  create() {
    ...
    confirmDialogRef.afterClosed().subscribe(result => {
      ...
      const item = new Partner({ caption: this.newTitle });
